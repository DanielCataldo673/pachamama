...
const Suculentas = ({ cart, handleAddToCart, isCartOpen, setCartOpen, borrarProducto, vaciarCarrito }) => {
  ...
  return (
    <>
      ...
      {carga ? (
        ...
        <ProductList products={productos.filter(producto => producto.clasificacion === 'Suculentas')} addToCart={handleAddToCartWithStock} stocks={stocks} resetAll={resetAll} resetProductId={resetProductId} />
