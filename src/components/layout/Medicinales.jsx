...
const Medicinales = ({ cart, handleAddToCart, isCartOpen, setCartOpen, borrarProducto, vaciarCarrito }) => {
  ...
  return (
    <>
      ...
      {carga ? (
        ...
        <ProductList products={productos.filter(producto => producto.clasificacion === 'Plantas Medicinales')} addToCart={handleAddToCartWithStock} stocks={stocks} resetAll={resetAll} resetProductId={resetProductId} />
