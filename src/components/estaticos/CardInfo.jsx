  ...
  return (
    <div>
      ...
      <div className="item item5">
            <a href="/contacto" target="_self"><svg xmlns="http://www.w3.org/2000/svg" height="90" width="90"
                viewBox="0 0 640 512">
                <path fill="#27391C"
          ...
          <div className="item item8">
            <a href="/ayuda" target="_self"><svg xmlns="http://www.w3.org/2000/svg" height="90" width="90"
                viewBox="0 0 576 512">
                <path fill="#27391C"
